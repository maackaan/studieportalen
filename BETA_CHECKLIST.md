...
Status 2026-09-23: 20 Python-tester, 6 kalendertester och isolerade gränssnittstester är godkända för `0.1.0-beta.3`. Testerna omfattar även allmänna poster, Information, fem kurser, sparad kursordning, typanpassade längder, informationsrutan och samtliga huvudvyer vid 360, 520, 768 och 1280 pixlar. De kontrollerar dessutom att händelsetext inte överlappar åtgärder och att resursknappar inte klipps bort. GitHub Actions har godkänt testmatrisen, byggt och självtestat Windows-paketet i en ren byggmiljö samt byggt, starttestat och paketerat macOS-versionerna för både Apple Silicon och Intel. Både användaren och en testare har tidigare laddat ned beta 2 och bekräftat att appen går att öppna.
